...
{
    public class InternalDetailPageViewModel : BaseViewModel
    {
        ...
        private InternalPostItem _postItem;
        public InternalPostItem PostItem
        {
            get => _postItem;
        ...
        public IInternalPostItemService _postItemService { get; private set; }
        ...
        public InternalDetailPageViewModel()
        {
            _postItemService = DependencyService.Get<IInternalPostItemService>();
