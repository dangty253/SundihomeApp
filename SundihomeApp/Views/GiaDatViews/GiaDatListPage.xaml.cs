    ...
    public partial class GiaDatListPage : ContentPage
    {
        ...
        public GiaDatListPage()
        {
            ...
            ProvinceList = new List<PageOption>()
            {
                ...
                new PageOption(){Id=19,Name="Thái Nguyên",Type=typeof(GiaDatThaiNguyenPage) },
                new PageOption(){Id=24,Name="Bắc Giang" },
                new PageOption(){Id=42,Name="Hà Tĩnh",Type=typeof(GiaDatHaTinhPage) },
                ...
                new PageOption(){Id=77,Name="Bà Rịa - Vũng Tàu", Type = typeof(GiaDatVungTauPage)},
