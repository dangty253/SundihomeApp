...
namespace SundihomeApp.Views.GiaDatViews
{
    ...
    public partial class GiaDatSonLaPage : ContentPage
    {
        public GiaDatSonLaPageViewModel viewModel;
        public GiaDatSonLaPage()
        {
            InitializeComponent();
            this.BindingContext = viewModel = new GiaDatSonLaPageViewModel();
