...
namespace SundihomeApp.Views.GiaDatViews
{
    ...
    public partial class GiaDatDongNaiPage : ContentPage
    {
        public GiaDatDongNaiPageViewModel viewModel;
        public GiaDatDongNaiPage()
        {
            InitializeComponent();
            this.BindingContext = viewModel = new GiaDatDongNaiPageViewModel();
        ...
        private async void District_Changed(object sender, EventArgs e)
        {
            ...
            if (viewModel.District?.Id == 731 || viewModel.District?.Id == 732)
            {
