...
{
    public partial class AddToDayPage : ContentPage
    {
        public AddToDayPageViewModel viewModel;
        ...
        {
            Title = Language.dang_thanh_ly_trong_ngay;
        ...
        public async Task<ApiResponse> UploadImage(MultipartFormDataContent form)
        {
            ...
            HttpResponseMessage uploadResponse = await client.PostAsync(ApiConfig.CloudStorageApi + "/api/files/upload?folder=liquidation_today", form);
