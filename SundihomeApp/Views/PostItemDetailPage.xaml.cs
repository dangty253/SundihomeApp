...
namespace SundihomeApp.Views
{
    public partial class PostItemDetailPage : ContentPage
    {
        ...
        private SearchPageResultViewModel searchPageResultViewModel;

        public PostItemDetailPage(PostItem postItem)
        {
            InitializeComponent();
            this.BindingContext = viewModel = new PostItemDetailPageViewModel();
        ...
        private async void FollowPost_Clicked(object sender, EventArgs e)
        {
            ...
            MessagingCenter.Send<PostItemDetailPage, PostItem>(this, "OnUpdateFollow", viewModel.PostItem);
