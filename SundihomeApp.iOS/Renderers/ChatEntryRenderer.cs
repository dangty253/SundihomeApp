...
using SundihomeApp.Views.Partials;
using UIKit;
using Xamarin.Forms;
    ...
    public class ChatEntryRenderer : ViewRenderer //Depending on your situation, you will need to inherit from a different renderer
    {
        ...
        void OnKeyboardShow(object sender, UIKeyboardEventArgs args)
        {
            ...
            if (Element != null)
            {
                ...
                Element.Margin = new Thickness(0, 0, 0, keyboardSize.Height - bottom); //push the entry up to keyboard height when keyboard is activated
            }
        }
